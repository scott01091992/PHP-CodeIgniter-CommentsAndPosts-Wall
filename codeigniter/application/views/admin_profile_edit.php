			...
			<nav class="navbar navbar-default">
        		<div class="container-fluid">
          			<div class="navbar-header">
            			...
            			<a href='/admin_dashboard' class="navbar-brand">Admin Dashboard</a>
          			</div>
          			<div id="navbar" class="navbar-collapse collapse">
            			<ul class="nav navbar-nav">
              				<li class="active"><a href="/admin_profile">Profile</a></li>
            			</ul>
            ...
            <div class='row'>
                <div class='col-xs-6'>
                   <div id='edit-info'>
                        ...
                        <form action=<?= "'/admin_update_info/".$user['id']."'" ?> method='post'>
                ...
                <div class='col-xs-6'>
                    <div id='password_change'>
                        ...
                        <form action=<?= "'/admin_update_password/".$user['id']."'" ?> method='post'>
                            <div class='form-group'>
            ...
            <div class='row'>
                <div class='col-xs-12'>
                    <div id='edit-description'>
                        ...
                        <form action=<?= "'/admin_update_description/".$user['id']."'"?> method='post'>
                            <div class='form-group'>
